...
class SiteController extends Controller
{
        ...
        $points = array(
            '1' =>
                array('title' => 'Задание 1',
                    ...
                    'progress' => Yii::app()->session['Level_1_Progress'],
                    'disabled' => 0),
            '2' =>
                array('title' => 'Задание 2',
                    ...
                    'progress' => Yii::app()->session['Level_2_Progress'],
                    'disabled' => 0),
            '3' =>
                array('title' => 'Задание 3',
                    ...
                    'link' => '3.php',
                    'progress' => Yii::app()->session['Level_3_Progress'],
                    'disabled' => 0),
            '4' =>
                array('title' => 'Задание 4',
                    ...
                    'link' => '4.php',
                    'progress' => Yii::app()->session['Level_4_Progress'],
                    'disabled' => 0),
            '5' =>
                array('title' => 'Задание 5',
                    ...
                    'link' => '5.php',
                    'progress' => Yii::app()->session['Level_5_Progress'],
                    'disabled' => 0),
            '6' =>
                array('title' => 'Задание 6',
                    ...
                    'link' => '6.php',
                    'progress' => Yii::app()->session['Level_6_Progress'],
                    'disabled' => 0)
        );
    ...
    public function actionSaveResult(){
        ...
        if (isset($_POST)){
            $level = $_POST['level'];
            Yii::app()->session['Level_'.$level.'_Progress'] = $_POST['progress'];
            $result = true;
        }
